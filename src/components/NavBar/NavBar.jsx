                ...
                <button id='theme-toggle' onClick={toggleTheme} >
                  {
                    isDarkMode ?
                      <svg id="sun"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="0 0 24 24" fill="none" stroke="#e4e6eb" strokeWidth="2" strokeLinecap="round">
                      ...
                      <svg id="moon"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2" strokeLinecap="round">
